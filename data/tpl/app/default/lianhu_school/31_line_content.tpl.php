            ...
            <?php  $student_info = $class_student->getStudentInfo($student_id);?>
             ...
             <li class="box" >
            		<div class="author">
                            ...
                            <p class="author_name"> <?php  if(!teacher_result) { ?><?php  echo $student_info['student_name'];?>（<?php  echo $row['relation'];?>）<?php  } else { ?><?php  echo $teacher_result['teacher_realname'];?>(教师)<?php  } ?></p>
