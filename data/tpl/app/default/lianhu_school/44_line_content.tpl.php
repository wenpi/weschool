           ...
           <?php  } ?>
            ...
            <?php  } ?>
             ...
             <li class="box" >
            		<div class="author">
                    		<a href="#">
                                <img src="<?php  echo $_W['attachurl'];?><?php  if($teacher_result) { ?><?php  echo $this->getTeacherImg($teacher_result['teacher_id']);?><?php  } else { ?><?php  echo $student_info['student_img'];?><?php  } ?>">
                            </a>
                            <p class="author_name"> 
