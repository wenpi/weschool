...
<body>
 <div class="top-wrap">
        <div class="fn-clear tr-box top">
            <div class='text_center'>教师到校扫码</div>
        </div>
  </div> 
    ...
    <?php  if($have_send) { ?>
    <a href="#" class="button button-block button-rounded  button-large">上学成功</a>
    <?php  } else { ?>
    <a href="<?php  echo $url;?>&send=1" class="button button-block button-rounded button-action button-large">确认到校</a>
    <?php  } ?>
