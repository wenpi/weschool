            ...
            <?php  if(is_array($list)) { foreach($list as $row) { ?>
              <div >
                ...
                <div class="separator-button"> </div>
                  ...
                  <?php  } else { ?>
                  <div class="w-embed w-video w-iframe"  onclick="lookIframe(this,<?php  echo $row['list_id'];?>,'<?php  echo $row['list_src_content']; ?>')" style="padding-top: 56.17021276595745%;background-image:url(<?php  echo $_W['attachurl'];?>/<?php  echo $row['list_img'];?>)">
