      ...
      <div class="w-tab-pane  w--tab-active tab-pane" data-w-tab="Tab 1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>简要内容[或者短信内容]</label>
							<div class="col-sm-9 col-xs-10">
								<textarea name='intro' class='form-control' placeholder="内容简短，120字内！" required maxlength="120"></textarea>
							</div>
						</div>
