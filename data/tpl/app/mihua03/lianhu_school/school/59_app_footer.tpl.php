<?php defined('IN_IA') or exit('Access Denied');?>
  ...
  <script type="text/javascript" src="<?php echo MODULE_URL;?>/style/app/js/chart.v3.min.js"></script>
  <!--[if lte IE 9]><script src="<?php echo MODULE_URL;?>/style/app/js/placeholders.min.js"></script><![endif]-->