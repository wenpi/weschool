		...
		<div class=" panel-default">
			<div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <input type="text" name="admin_name" id="admin_name"  value='<?php  echo $student_name;?>' />
				</div>
				<div class="form-group">
                    ...
                    <input class="info" type="text"  value='添加个人头像'  readonly="true" />
                     <div id='img_list' class="img_list" style='margin-bottom:15px;'  >
                        <div style="background-size:cover; background-image:url(<?php  echo $school_logo;?>);width:100px;; height:100px;float:left;margin-left:2%;overflow: hidden; margin-bottom:5px;"></div>
                    </div>
                    <div  class='hide' id='img_value'> </div>  
                        <div class="button button-action button-rounded button-small btn btn-primary left_btn" id="chooseImage" style="width: 100px">选择照片</div>
                        <div style="clear:both"></div>
                        <div id='uploadImg' style='margin-top:5px;margin-left:50px;color:green'></div>
                    </div>
				</div>
			</div>
...
<script>
    $(function(){
         <?php  if($school_admin['info']['admin_img']) { ?>
            insertImg('<?php  echo $this->imgFrom($school_admin['info']['admin_img']);?>','img_list');
            $("#in_tea_img").attr('src','<?php  echo $this->imgFrom($school_admin['info']['admin_img']);?>');
        <?php  } ?>
        insertValue('<?php  echo $school_admin['info']['admin_img'];?>','img_value');
