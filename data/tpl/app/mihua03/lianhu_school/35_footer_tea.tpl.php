...
<div id="menu">
	<ul>
		<li>
			<div class="menu_li"><img src="<?php echo MODULE_URL;?>template/mobile/style/coin.png" width="10" /> <a href="<?php  if($this->school_info['host_url'] ) { ?><?php  echo $this->school_info['host_url'];?><?php  } else { ?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=wapHome&m=lianhu_school <?php  } ?> ">微官网</a></div>
