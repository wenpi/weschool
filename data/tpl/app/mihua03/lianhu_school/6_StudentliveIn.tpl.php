...
<body>
 <div class="top-wrap">
    ...
    <div class='main' style="margin-top:10%">
        ...
        <a href="<?php  echo $this->createMobileUrl('tea_work_record',array("model"=>"someone",'sid'=>$student_re['student_id']));?>" class="button button-block button-rounded button-action  button-large" style='margin-top:10px;'>添加学生记录</a>
    </div>
