...
<head>
    ...
    <title>学生相册-<?php  echo $_SESSION['school_name'];?></title>
...
<div class="top-wrap">
        <div class="fn-clear tr-box top bg_yellow" >
            <div class='text_center white'>学生相册-<?php  if($model=='class') { ?>班级列表<?php  } else if($model=='student') { ?>选择学生<?php  } else if($model=='someone') { ?>发送<?php  } ?></div>
        </div>
 </div> 
<div class="main">
        ...
        <form   method="post"  id="form1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    添加新的相册【<?php  echo $result['student_name'];?>】
                </div>
                <div class="panel-body">
