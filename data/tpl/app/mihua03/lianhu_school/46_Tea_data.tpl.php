			...
			<div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div id='img_list_qr' class="img_list" style='margin-bottom:15px;'  >
                        <div style="background-size:cover; background-image:url(<?php echo MODULE_URL;?>icon.jpg);width:100px;; height:100px;float:left;margin-left:2%;overflow: hidden; margin-bottom:5px;"></div>
                    </div>
                    <!--<div style='clear:both'></div>-->
                    <div  class='hide' id='img_value_qr'> </div>
                    <div class="button button-action button-rounded button-smallbtn btn btn-primary left_btn" id="chooseImage_qr" style="width: 100px" >选择照片</div>
