...
<body style="margin-bottom:60px;">
   ...
   <h1><?php  echo $result['appointment_name'];?></h1>
    <div class="other"><u><?php  if($result['appointment_type_limit']==0) { ?>全校<?php  } else if($result['appointment_type_limit']==1) { ?>年级<?php  } else if($result['appointment_type_limit']==2) { ?>班级<?php  } ?></u>|<time><?php  echo date("Y-m-d",$result['appointment_start']);?>--<?php  echo date("Y-m-d",$result['appointment_end']);?></time>|<i><a href=" ">申请(<?php  echo $result['appointment_join_num'];?>)</a></i></div>
