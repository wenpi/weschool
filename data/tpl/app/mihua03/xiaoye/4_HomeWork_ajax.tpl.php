<?php defined('IN_IA') or exit('Access Denied');?>  <script>
    ...
    <?php  if(is_array($list)) { foreach($list as $row) { ?>
        <div class="zy">
        <div class="zy-tp">
            <div style="width:50px;height:50px;border-radius:50%;background-image: url(<?php  echo D('teacher')->teacherImg($row['teacher_id']);?>)" class="background_img"></div>
        </div>
        <div class="zy-t"  style="margin-left: 5px;">
        ...
        <div class="zy-tt" style="margin-left: 75px;">
        ...
        <?php  } ?>
        <?php  if($row['voice']) { ?>
            <div class="zy-yyy" style="margin-left: 75px;float: left; width: 240px;">
                <div>
