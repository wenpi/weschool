...
<div class="weui_dialog_alert"  id="student_code_area" style="display:none"  data-dis='no'onclick="changeDisplay('student_code_area')" >
    <div class="weui_mask"  ></div>
    <div class="weui_dialog"  >
        <div class="weui_dialog_hd"><strong class="weui_dialog_title" style="font-size: 1px;">学生考勤二维码</strong></div>
        <div class="weui_dialog_bd">
...
<div class="all" style="width:100%;">
  <div class="headzy background_img" style="background-image:url(<?php  echo $this->imgFrom(D('adv')->getAdvInfoKeyWord('student_top_img')) ; ?>);">
    <div class="QH">
    ...
    <div class="L-D-R" style="position: absolute;left:20%">
