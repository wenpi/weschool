                    ...
                    <ul class="z_txx">
                        <?php  if(is_array($row['student_list'])) { foreach($row['student_list'] as $k => $val) { ?>
                            <li>
                                ...
                                <div class="z_txx3"><a href="<?php  echo $this->createMobileUrl('chatMessage',array('s_id'=>$val['student_id'],'type'=>'student','in_type'=>'as_teacher' ))?>"><img src="<?php echo MODULE_URL;?>/template/xiaoye/img/pl.png"></a></div>
                                <?php  if($val['parent_phone']) { ?>
                                <div class="z_txx3"><a href="tel:<?php  echo $val['parent_phone'];?>"><img src="<?php echo MODULE_URL;?>/template/xiaoye/img/Z_DH.png"></a></div>
                                <?php  } ?>
                            </li>
                        <?php  } } ?>
                    </ul>
                    ...
                    <ul class="z_txx">
                        <?php  if(is_array($teacher_list)) { foreach($teacher_list as $row) { ?>
                             <li>
                                ...
                                <div class="z_txx3"><a href="<?php  echo $this->createMobileUrl('chatMessage',array('o_id'=>$row['teacher_id'],'type'=>'teacher','in_type'=>'as_teacher' ))?>"><img src="<?php echo MODULE_URL;?>/template/xiaoye/img/pl.png"></a></div>
