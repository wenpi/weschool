...
<div class="z_main">
     <div class="TP">
        <p> <?php  echo $result['appointment_name'];?> </p>
        <p1><?php  if($result['appointment_type_limit']==0) { ?>全校<?php  } else if($result['appointment_type_limit']==1) { ?>年级<?php  } else if($result['appointment_type_limit']==2) { ?>班级<?php  } ?>&nbsp;
            <span><?php  echo date("m-d H:i",$result['appointment_start']);?>至<?php  echo date("m-d H:i",$result['appointment_end']);?></span>
        </p1>
        <div class="jz-tb">
        ...
        <?php  if(!$you_result ) { ?>
            ...
            <?php  } ?>
            		<div class="jzz">
                        ...
                        <?php  } else { ?>
                           <div class="z_dpt5">
                               <a href='<?php  echo $this->createMobileUrl('applist_result');?>'> <input type="button"  value="已经选择，无法修改，查看预约结果" style="font-size:12.4px;font-weight:300;"> </a>
                            </div>
                        <?php  } ?>
            </form>         
