    ...
    <li class="z_bj" id="list_id_<?php  echo $row['send_id'];?>">
        ...
        <div class="z_bj11">
            ...
            <div class="z_bjt13" style="height:300px;">
                <video src="<?php  echo tomedia($row['sendvideo'])?>" preload='none' controls="controls" style="width: 100%; heigth:300px;" height="300"  webkit-playsinline></video>
            </div>
            <?php  } ?>
                        ...
                        <div class="z_bjt163 comment_list_line"  id="comment_list_line<?php  echo $row['send_id'];?>"  style="color:#33cbd5;<?php  if(!$comment_list) { ?>display:none;<?php  } ?>" >
                            <?php  if($comment_list ) { ?>
                                    <?php  if(is_array($comment_list)) { foreach($comment_list as $val) { ?>
                                        <p><?php  echo $val['nickname'];?>：<?php  echo $val['comment_text'];?></p>
                                    <?php  } } ?>
                            <?php  } ?>                   
                        </div>
                </div>
