...
<?php  if(is_array($list)) { foreach($list as $row) { ?>
    <li class="z_bj" id="list_id_<?php  echo $row['photo_id'];?>">
        ...
        <div class="z_bj11">
            <div class="z_bjt12" style="font-size: 1.8rem;padding-left: 20px;" ><?php  echo date("m-d H:i",$row['add_time']);?></div>
            ...
            <?php  } ?> 
             <div class="z_bjt15" >
                    <p style="font-size: 2rem;padding-left: 20px;">来自<?php  echo $row['sendname'];?><?php  if($row['title']) { ?>:<?php  echo $row['title'];?><?php  } ?></p>
            </div>
        </div>
    </li>
<?php  } } ?>