...
<form class="form-horizontal" method="post" role="form" action="<?php  echo $this->createMobileUrl('findPass')?>">
    ...
    <div class="con1z">
        ...
        <div class=" mgz bd">
            <input type="submit" class="dlz cen xi32 bai" value="找回" name="submit">
        </div>
</body>
<script>
    var do_in = 0;
    ...
    $(function(){
        $("#sendClick").click(function(){
            ...
            $.ajax({
                url:'<?php  echo $this->createMobileUrl('findPass')?>',
                type:'post',
