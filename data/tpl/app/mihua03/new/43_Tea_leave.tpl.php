                    ...
                    <form action="" method="post" class="form-horizontal form" id="form1" >
                                ...
                                <div class="weui_panel_bd">
                                    <div class="weui_media_box weui_media_text">
                                        ...
                                        <?php  if($result['leave_voice']) { ?>
                                            <p class="weui_media_desc"><audio src="<?php  echo $this->imgFrom($result['leave_voice']);?>" controls ></audio></p>
                                        <?php  } ?>
                        ...
                        <div class="weui_cell">
                            <div class="weui_cell_bd weui_cell_primary">
                                <textarea class="weui_textarea" placeholder="内容（必须填写）" rows="5" name="teacher_text" autofocus required ></textarea>
                            </div>
