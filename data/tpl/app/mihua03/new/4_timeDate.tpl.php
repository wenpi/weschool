<?php defined('IN_IA') or exit('Access Denied');?> <link rel="stylesheet" href="<?php echo MODULE_URL;?>/template/xiaoye/css/default/default.css">
 ...
 <script type="text/javascript">
        var $input = $( '.datepicker' ).pickadate({
            ...
            closeOnClear: false,
            hiddenName:true,
            value:"<?php  echo date("d",$in_time)?> <?php  echo C('week')->date_num[date("n",$in_time)]?>月, <?php  echo date("Y",$in_time)?>",
            url:"<?php  echo $url;?>",
        })
</script>
<style>
