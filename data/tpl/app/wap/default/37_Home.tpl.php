		...
		<div id="zzjs_zzjs_net_<?php  echo $k;?>" class=" <?php  if($k==0) { ?> hover <?php  } ?> TabContent" <?php  if($k!=0) { ?> style="display:none" <?php  } ?> >
			<dl>
				<a href ="<?php  echo  $this->createMobileUrl('wapContent',array('aid'=>$v[0]['list_id']))?>">
					<div style="background: url(<?php  echo $_W['attachurl'];?><?php  echo $v[0]['artice_img'];?> ) no-repeat;background-size:100%;background-position: top;   width: 119px;height: 82px;float:left; margin-right: 10px;"></div>
					<div class="iNews_top_r">
						<h3 style="font-size: 1.2em;max-height: 3em;line-height: 1.5em;overflow: hidden"><?php  echo $v[0]['article_title'];?></h3>
