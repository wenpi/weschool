	...
	<script>
		wx.ready(function () {
			wx.onMenuShareTimeline({
				...
				link: '<?php  if($school_info['host_url'] ) { ?><?php  echo $school_info['host_url'];?><?php  } else { ?><?php  echo $_W['siteurl'];?><?php  echo $this->createMobileUrl('wapHome',array('school_id'=>$school_info['school_id']))?><?php  } ?>', // 分享链接
