	...
	<script>
		wx.ready(function () {
			wx.onMenuShareTimeline({
				title: '<?php  echo $result['article_title'];?>',  
				link: '<?php  echo $_W['siteroot'];?>/app/<?php  echo $this->createMobileUrl("wapContent",array("aid"=>$_GPC['aid']))?>', // 分享链接
				imgUrl: '<?php  echo $_W['attachurl'];?><?php  echo $img_list[0]['content'];?>',  
			});
