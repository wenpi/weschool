...
<body style='background-color:#efefef;'>
    <div class="box">
        ...
        <div class="id_box user_bg">
           ...
           <div class="name_bg">
            <div class="name_edit" id="div_about"><span class="name_sm"></span><span class="dji">学号：<?php  echo $result['xuehao'];?></span>
			 ...
			 <div class="name_edit" id="div_about"><span class="name_sm"></span><span class="dji">班级：<?php  echo $result['grade_name'];?>-<?php  echo $result['class_name'];?></span></div>  
	    ...
	    <div class="userlist">
		 ...
		 <div class="userlist">
			 <a href="<?php  echo $this->createMobileUrl('myInfo') ?>"><li class="user_bg" style="border-bottom:none;" ><i   class="fa fa-info-circle" style="color:#A5DE37"></i><div class="ca_name">我的资料</div></li></a>
