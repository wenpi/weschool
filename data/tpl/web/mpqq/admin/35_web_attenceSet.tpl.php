                                            ...
                                            <div class="col-md-10 ">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input  ">
                                                        <div class="input-icon col-md-8">
                                                            <input type="text"  name="begin_time" class="form-control" value="<?php  echo $result['begin_time'];?>" placeholder="00:00"  >
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input has-warning">
                                                        <div class="input-icon col-md-8">
                                                        <input type="text" name="end_time" class="form-control" value="<?php  echo $result['end_time'];?>" placeholder="12:00" >
