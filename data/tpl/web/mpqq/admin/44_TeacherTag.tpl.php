                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="portlet-body form">
                                        <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-4 control-label">标签名</label>
                                                    <div class="col-md-8">
                             ...
                             <div class="col-md-6">
                                <div class="portlet box green-turquoise">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-navicon"></i>标签列表 <b class="font-red"><?php  echo $out_msg;?></b></div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body flip-scroll">
                                        <table class="table table-bordered table-striped table-condensed flip-content table-light  ">
                                            ...
                                            <tr>
                                                <th width="400">名称<b class="font-red">【点击标签名编辑，点击其他区域提交】</b></th>
                                                <th>操作</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                                        <tr>
                                                            <td><input value='<?php  echo $item['tag_name'];?>' data-id ='<?php  echo $item['tag_id'];?>' data-name='tag_name' class="form-control" onblur="ajaxChange(this,'<?php  echo $this->createWebUrl('teacherTag',array('ac'=>'edit'))?>')" class="col-md-4 font-blue-steel"></td>
                                                            <td style="text-align: center">
                                                                    <a  href="<?php  echo $this->createWebUrl('teacherTag',array("id"=>$item['tag_id'],'ac'=>'delete' ) );?> " class="btn red">
