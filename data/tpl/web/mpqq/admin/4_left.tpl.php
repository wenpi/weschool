                              ...
                              <li class="nav-item  "  id='repairFix' <?php  checkLeft('repairFix',$fun_info['low']);?>>
                                ...
                                <li class="nav-item"  id='schoolHouse'  <?php  checkLeft('schoolHouse',$fun_info['top']);?>>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item"  id='teaRoom' <?php  checkLeft('teaRoom',$fun_info['low']);?>>
                                                <a href="<?php  echo $this->createWebUrl('teaRoom')?>" class="nav-link ">
                                                    <span class="title"><i class="fa fa-square-o"></i> 教室管理</span>
                                                </a>
                                        </li>
                                        <?php  if($file_re) { ?>
                    ...
                    <?php  if($admin_result['admin'] == 'top'  ||  $left_nav =='system_parameter') { ?>
                        <li class="nav-item" id='system_set' <?php  checkLeft('system_set',$fun_info['top']);?> >
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item" id='mpMenu' <?php  checkLeft('mpMenu',$fun_info['low']);?>>
                                    <a href="<?php  echo $this->createWebUrl('mpMenu') ?>" class="nav-link">
                                        <span class="title"><i class="fa fa-reorder"></i> 公众号菜单 </span>
                                    </a>
                                </li>  
