                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" name="in_school_year" id="in_school_year" class="form-control" value='<?php  echo $result['in_school_year'];?>' required />
                                                    <div class="form-control-focus"> </div>
                 ...
                 <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-navicon"></i>年级列表 </div>
                                        <div class="tools">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr>
                                                ...
                                                <td> <a class="label label-sm label-success" href='<?php  echo $this->createWebUrl('class',array('grade_id'=>$item['grade_id'],'aw'=>1 ))?>'><?php  echo $item['grade_name'];?> </td>
                                                <td class="numeric"> <?php  echo $item['in_school_year'];?></td>
                                                <td class="numeric"> <?php  echo $this->grade_class_num($item['grade_id']);?> </td>
                                                <td>
                                                    <a  href="<?php  echo $this->createWebUrl('grade', array('ac' => 'edit','id'=>$item['grade_id'],'aw'=>1))?>" class="btn blue">
