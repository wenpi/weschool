                                        ...
                                        <?php  if($class_studentCard) { ?>  
                                            <div class="portlet-body form">
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="studentCardLogin" id="studentCardLogin" class="form-control" value='<?php  echo $result['studentCardLogin'];?>' placeholder="默认账号是：背面的IMEI码" />
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-2 control-label">电子学生卡密码</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="studentCardPwd" id="studentCardPwd" class="form-control" value='<?php  echo $result['studentCardPwd'];?>'  placeholder="默认密码是：123456"/>
                                                    </div>
                                                </div> 
                                            </div>                                          
                                        <?php  } ?>                                                                
                                         ...
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr>
                                                ...
                                                <div class="btn-group btn-group-solid">
                                                     <a  href="<?php  echo $this->createWebUrl('student', array('id' => $item['student_id'], 'op' => 'student','ac'=>'edit','aw'=>1))?> " class="btn  purple">编辑 </a>
                                                     ...
                                                     <a href="<?php  echo $this->createWebUrl('qrcode', array('id' => $item['student_id'], 'op' => 'student_live_student' ))?>" class="btn yellow " target="_blank" title="打印考勤二维码">考勤</a>
                                                     <a href="<?php  echo $this->createWebUrl('qrcode', array('id' => $item['student_id'], 'op' => 'student_bd_student' ))?>" class="btn red " target="_blank" title="打印绑定二维码">绑定</a>
                                                     <?php  if($class_studentCard) { ?>
