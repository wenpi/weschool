                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;">
                                                        <a href="<?php  echo $this->createWebUrl('course', array( 'ac' => 'edit','cid'=>$item['course_id'],'aw'=>1 ))?>" class="btn btn-success btn-sm">  <i class="fa fa-edit"></i> 编辑</a>
                                                        <a href="<?php  echo $this->createWebUrl('course', array('ac' => 'delete','cid'=>$item['course_id'],'aw'=>1 ))?>" 
                                                            onclick="return confirm('此操作不可恢复，确认删除？');"
                                                            class="btn btn-default btn-sm" ><i class="fa fa-times"></i>删除
                                                        </a>
