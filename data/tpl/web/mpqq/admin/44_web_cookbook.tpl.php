                                                ...
                                                <?php  if(is_array($out_times)) { foreach($out_times as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <?php  if(is_array($cookbook_class_arr)) { foreach($cookbook_class_arr as $val) { ?>
                                                            <td>
                                                                <input type="text" class="form-control" name = "cookbook[<?php  echo $val;?>][<?php  echo $row['unix'];?>]" value="<?php  echo C('cookbook')->getCookbookText($val,$row['unix']);?>"  >
                                                                <?php  echo tpl_form_field_multi_image('img['.$val.']['.$row["unix"].']', C('cookbook')->getCookbookImg($val,$row['unix']) );?>
                                                            </td>
                                                        <?php  } } ?>
                                                    </tr>
                                                <?php  } } ?>
