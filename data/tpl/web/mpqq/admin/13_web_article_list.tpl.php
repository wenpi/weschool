                                        ...
                                        <tbody>
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="<?php  echo $this->createWebUrl('article_list', array('id' => $item['list_id'], 'op' => 'student','ac'=>'edit','aw'=>1))?> " class="btn btn-outline btn-circle btn-sm purple">
                                                                <i class="fa fa-edit"></i> 编辑 </a>
                                                    <a href="<?php  echo $this->createWebUrl('article_list', array('id' => $item['list_id'], 'op' => 'student','ac'=>'delete','aw'=>1))?>" 
                                                        onclick="return confirm('此操作不可恢复，确认删除？');"
                                                        class="btn btn-outline btn-circle dark btn-sm black" title="删除"><i class="fa fa-trash-o"></i>
                                                        删除
                                                    </a>  
                                                    <a  target="_blank" href="<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapContent', array('aid' => $item['list_id']))?> " class="btn btn-outline btn-circle btn-sm purple">
