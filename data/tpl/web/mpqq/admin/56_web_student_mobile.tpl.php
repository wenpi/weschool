        ...
        <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../admin/left', TEMPLATE_INCLUDEPATH)) : (include template('../admin/left', TEMPLATE_INCLUDEPATH));?>
            ...
            <!--结束公共头部-->
                <div class='row'>
                     <div class="col-md-12">
                         <?php  if($op=='list') { ?>
                         <?php  if(S("system",'getSetContent',array('xiaoye_bottom',$this->school_info['school_id'])) ==1 || $mu_str!='xiaoye') { ?>
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-navicon"></i>家长端底部导航列表</div>
                                    <div class="tools">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($button_list)) { foreach($button_list as $item) { ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php  if($mu_str =='xiaoye') { ?><?php  echo $this->imgFrom($item['xiaoyeimg'])?><?php  } else { ?><?php  echo $this->imgFrom($item['img'])?><?php  } ?>" width="70"></td>
                                                <td><?php  echo $item['sort'];?></td>
                                                <td><span class="label label-sm label-success"><?php  echo $item['keyword'];?></span></td>
                                                <td><?php  echo $item['url'];?></td>
                                                <td><?php  echo date("Y-m-d H:i:s",$item['add_time']);?></td>
                                                <td><span class="label label-sm label-warning"><?php  if($item['status']== 1) { ?>正常<?php  } else { ?>隐藏<?php  } ?></span></td>
                                                <td style="text-align: center">
                                                   <div class="btn-group btn-group-solid">
                                                    <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['display_id'], 'op' => 'edit','ac'=>'button' ))?> " class="btn blue">
                                                                <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                     <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['display_id'], 'op' => 'delete','ac'=>'button' ))?> " class="btn red">
                            ...
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-tree"></i>新首页的七个菜单 </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"> </a>
                                    </div>
                                </div>
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content table-light">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($new_list)) { foreach($new_list as $item) { ?>
                                            <tr>
                                                <td><?php  echo $item['name'];?></td>
                                                <td class="success"><img src="<?php  echo $this->imgFrom($item['xiaoyeimg'])?>" width="70"></td>
                                                <td><?php  echo $item['sort'];?></td>
                                                <td><span class="label label-sm label-success"><?php  echo $item['keyword'];?></span></td>
                                                <td><?php  echo $item['url'];?></td>
                                                <td><?php  echo date("Y-m-d H:i:s",$item['add_time']);?></td>
                                ...
                                <div class="portlet box green-turquoise">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-navicon"></i>家长端首页控制 </div>
                                        <div class="tools">
                                            <a href="javascript:;" class="collapse"> </a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed flip-content table-light">
                                            ...
                                            <?php  if(is_array($index_list)) { foreach($index_list as $item) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src='<?php  echo $this->imgFrom($val['img'])?>' width="70px"></td>
                                                    <td><?php  echo $val['sort'];?></td>
                                                    <td><span class="label label-sm label-success "><?php  echo $val['keyword'];?></span></td>
                                                    <td><?php  echo $val['url'];?></td>
                                                    <td><?php  echo date("Y-m-d H:i:s",$val['add_time']);?></td>
                                                    <td><span class="label label-sm label-warning"><?php  if($val['status']== 1) { ?>正常<?php  } else { ?>隐藏<?php  } ?></span></td>
                                                    <td style="text-align: center" >
                                                        <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $val['display_id'], 'op' => 'edit','ac'=>'index_button' ))?> " class="btn blue">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $val['display_id'], 'op' => 'delete','ac'=>'button' ))?> " class="btn  red">
                                                                <i class="fa fa-close"></i> 删除
                                                        </a>   
                                                        </div>
                                                    </td>         
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-sm-10">
                                                <?php  if($mu_str=='xiaoye') { ?>
                                                    ...
                                                    <?php  echo upImg('xiaoyeimg',$result['xiaoyeimg'] ,$this);?>
                                                <?php  } else { ?>
                                                    <?php  echo upImg('img',$result['img'] ,$this);?>
                                                <?php  } ?>
                                            </div>
                                        </div>				
