                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                        <div class='form-group  form-md-line-input'>
                                            <label class="  col-md-2 control-label"><span class="required" aria-required="true"> * </span>选择班级</label>
                                            <div class="col-sm-10">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php  echo $this->createWebUrl('student', array('id' => $item['student_id'], 'op' => 'student','ac'=>'delete','aw'=>1))?>" 
                                                     ...
                                                     <a href="<?php  echo $this->createWebUrl('qrcode', array('id' => $item['student_id'], 'op' => 'student_live_student' ))?>" class="btn btn-outline btn-circle dark btn-sm " target="_blank" title="打印二维码"><i class="fa fa-barcode"></i>
                                                    </a>
