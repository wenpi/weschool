                                    ...
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                             ...
                                             <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label"><span class="required" aria-required="true"> * </span>渠道二维码关注欢迎语</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"  placeholder="渠道二维码关注欢迎语" value="<?php  echo S("system",'getSetContent',array('care_str',$school_id))?>" name='care_str' required >
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>                                                
