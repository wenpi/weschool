                                ...
                                <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                        ...
                                        <div class="form-group form-md-radios form-md-line-input  ">
                                            ...
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" id="parentsToparents" class="md-radiobtn" name="parentsToparents"   value='1' <?php  if(S("system",'getSetContent',array('parentsToparents',$school_id)) ==1 ) { ?> checked <?php  } ?>   />
                                                    <label for="parentsToparents">
                                                        <span></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span>开启</label>
                                                </div>
                                                <div class="md-radio">
                                                  <input type="radio"    id='parentsToparents2' class="md-radiobtn" name="parentsToparents"   value='0' <?php  if(S("system",'getSetContent',array('parentsToparents',$school_id)) ==0 ) { ?> checked <?php  } ?>   />
                                                    <label for="parentsToparents2">
                                                        <span></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span>关闭</label>
                                                </div>
