                                ...
                                <div class="portlet-title">
                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                              <div class="form-group form-md-line-input">
                                               ...
                                               <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">班级公告分类</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control"  placeholder="班级公告||班级食谱||班级相册" value="<?php  echo $result['msg_class'];?>" name='msg_class'  >
                                                        <div class="form-control-focus"> </div>
                                            ...
                                            <?php  if(Au('src/codeShop')->getCode('xuznfenqu') ) { ?>
                                                <?php  $num = Au("fenqu/action")->checkNoUseChannel();?>
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <label class="col-md-2 control-label">播报内容</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control"  value="<?php  echo $result['channel_content'];?>" name='channel_content' required >
                                                                <div class="form-control-focus"> </div>
                                                            </div>
                                                    </div>
                                                    <div class="form-group form-md-line-input">
                                                        <label class="col-md-2 control-label">播报备注</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" value="<?php  echo $result['channel_intro'];?>" name='channel_intro' required >
                                                                <div class="form-control-focus"> </div>
                                                            </div>
                                                    </div>                                                                                                                                
                                            <?php  } ?>
