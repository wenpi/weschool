                         ...
                         <?php  if($op=='list') { ?>
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>管理端底部导航列表 </div>
                                    <div class="tools">
                                            ...
                                            <tr >
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('schoolAdmin_mobile', array('id' => $item['display_id'], 'op' => 'edit','ac'=>'button' ))?> " class="btn blue">
                                ...
                                <div class="portlet box green-turquoise">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-cogs"></i>管理端首页控制 </div>
                                        <div class="tools">
                                            <a href="javascript:;" class="collapse"> </a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed flip-content table-light">
                                            ...
                                            <?php  if(is_array($index_list)) { foreach($index_list as $item) { ?>
                                                <tr class="success">
                                                    ...
                                                    <td><span class="label label-sm label-warning"><?php  if($item['top']['status']== 1) { ?>正常<?php  } else { ?>隐藏<?php  } ?></span></td>
                                                    <td style="text-align: center">
                                                    <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('schoolAdmin_mobile', array('id' => $item['top']['display_id'], 'op' => 'edit','ac'=>'index_top' ))?> " class="btn yellow">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a  href="<?php  echo $this->createWebUrl('schoolAdmin_mobile', array('id' => $item['top']['display_id'], 'op' => 'new','ac'=>'index_button' ))?> " class="btn red">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                    <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('schoolAdmin_mobile', array('id' => $val['display_id'], 'op' => 'edit','ac'=>'index_button' ))?> " class="btn blue">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                    </div>
                                                    </td>         
