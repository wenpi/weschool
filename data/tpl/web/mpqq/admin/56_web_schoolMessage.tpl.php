                                                    ...
                                                    <div class="mt-action" id='message_area_<?php  echo $row['message_id'];?>'>
                                                        ...
                                                        <div class="mt-action-body">
                                                            <div class="mt-action-row">
                                                                ...
                                                                <div style="display:none" id='content_<?php  echo $row['message_id'];?>'>
                                                                            <?php  echo $row['message_content'];?><br>
                                                                                <?php  if($row['imgs']) { ?>
                                                                                    <?php  $imgs = $this->decodeLineImgsToArr($row['imgs']);?>
                                                                                    <?php  if(is_array($imgs)) { foreach($imgs as $li) { ?>
                                                                                        <img src='<?php  echo $li;?>' style="height: 100px;width: 100px"/>
                                                                                    <?php  } } ?>
                                                                                <?php  } ?> 
                                                                    </div>
