                ...
                <div class="form-group form-md-line-input">
                    ...
                    <tbody id='grade_grade_list'>
                        ...
                        <tr class="odd gradeX">
                            <td>
                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                <input type="checkbox" class="checkboxes platform " value="<?php  echo $value['grade_id'];?>" name="grade_list[]" <?php  if($re['grade_list']) { ?> <?php  if(in_array($value['grade_id'], $re['grade_list'] ) ) { ?> checked <?php  } ?> <?php  } ?>/>
                                <span></span>
                            </label>
                            </td>
