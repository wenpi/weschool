            ...
            <div class="page-content-wrapper">
                ...
                <?php  if($ac=='list') { ?>
                 <div class="row">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr class="success">
                                                ...
                                                <td> <?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapCategories')?></td>
                                                <td>
                                                    <a  href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'edit','id'=>$item['class_id'] ))?>" class="btn blue">
                                                            <i class="fa fa-edit"></i> 编辑 </a>
                                                    
                                                    <a  onclick=" if(confirm('会删除本分类以及下级分类以及分类下的所有文章')){ return true;} return false; " target="_blank" href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'delete','id'=>$item['class_id'] ) )?> " class="btn red">
                                                            <i class="fa fa-close"></i> 删除 </a>    

                                                    <a  target="_blank" href="<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapCategories')?> " class="btn yellow">
                                            ...
                                            <?php  if(is_array($item['list'])) { foreach($item['list'] as $val) { ?>
                                              <tr >
                                                ...
                                                <td><?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapArticle', array('cid' => $val['class_id']))?> </td>
                                                <td><a  href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'edit','id'=>$val['class_id'] ))?>" class="btn blue">
                                                            <i class="fa fa-edit"></i> 编辑 </a>
                                                    <a  onclick=" if(confirm('会删除本分类以及分类下的所有文章')){ return true;} return false; " target="_blank" href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'delete','id'=>$item['class_id'] ) )?> " class="btn red">
                                                        <i class="fa fa-close"></i> 删除 </a>
                        ...
                        <div class="col-md-4">
                        <div class="tpl-phone fl tpl-phone-on">
							<div class="phone">
								<div class="inner inner-site-menu">
                                        <div class="site-top-bar"><a href="javascript:history.go(-1);" class="back"><span></span> 返回</a></div>
                                        <iframe src="<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapCategories')?>" width="100%" height="100%" id="iframe_weisite_1" scrolling="no" style="border:0;"></iframe>
                                        <div class="mask"></div>
                                </div>
							</div>
						</div>
