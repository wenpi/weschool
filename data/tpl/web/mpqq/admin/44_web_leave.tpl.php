                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                                ...
                                                <div class='form-group form-md-line-input'>
                                                        ...
                                                        <?php  echo date("Y-m-d H:i",$result['time_date_begin'])?>--<?php  echo date("Y-m-d H:i",$result['time_date_end'])?> 
                                                        </div>
                                                <div class='form-group form-md-line-input'>
                                                ...
                                                <?php  if($result['leave_voice']) { ?>
                                                  <div class='form-group form-md-line-input'>
                                                        <label class="  col-md-2 control-label">语音：</label>
                                                        <audio controls="controls" src="<?php  echo  $this->imgFrom($result['leave_voice']);?>">
                                                        </audio>
                                                </div>                                              
                                                <?php  } ?>
                                            <div class='form-group form-md-line-input'>
                 ...
                 <div class="row">
                        <div class="col-md-12">
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-navicon"></i>请假记录列表 </div>
                                    <div class="tools">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content table-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-sm label-info"><?php  echo $grade_info['grade_name'];?>~<?php  echo $this->className($item['class_id'])?></span></td>
                                                <td><?php  echo date("Y-m-d H:i",$item['time_date_begin'])?></td>
                                                <td><?php  echo date("Y-m-d H:i",$item['time_date_end'])?></td>
                                                ...
                                                <td><span class="label label-sm label-warning">
                                                    <?php  if($item['leave_status'] ==1) { ?>待审核<?php  } else if($item['leave_status'] ==2) { ?><span class="font-green-meadow">已同意</span><?php  } else { ?> <span class="font-red">未允许</span><?php  } ?>
                                                </span>
                                                </td>
                                                <td><?php  echo date("Y-m-d H:i:s",$item['add_time']);?></td>
                                                <td style="text-align: center">
                                                    <div class="btn-group btn-group-solid">
                                                    <a href="<?php  echo $this->createWebUrl('leave', array('id' => $item['leave_id'],'ac'=>'edit','aw'=>1 ))?>" class="btn blue" title="编辑"><i class="fa fa-edit"></i> 编辑</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php  } } ?>                                           
