                                             ...
                                             <?php  if(is_array($last_sends)) { foreach($last_sends as $row) { ?>
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img ">
                                                        <div style="background-image: url(<?php  if($row['teacher_result']) { ?> <?php  echo D('teacher')->teacherImg($row['teacher_result']['teacher_id']) ?> <?php  } else { ?> <?php  echo C('student')->studentImg($row['student_info']['student_id']);?><?php  } ?>);width:50px;height: 50px;border-radius: 50% !important;background-size: 100% 100%;" > </div>
                                                    </div>
