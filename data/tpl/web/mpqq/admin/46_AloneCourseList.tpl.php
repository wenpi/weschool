                                                            ...
                                                            <tr>
                                                                ...
                                                                <td  style="text-align:center;"  > 
                                                                 <div class="btn-group btn-group-solid">
                                                                    <a href="<?php  echo $this->createWebUrl('aloneCourseList', array('ac' => 'edit','id'=>$item['course_id']))?>"  class="btn   blue"  > <i class="fa fa-edit"></i>编辑</a>
                                                                    <a href="<?php  echo $this->createWebUrl('aloneCourseList', array('ac' => 'delete','id'=>$item['course_id']))?>" class="btn  red"  > <i class="fa fa-times-circle-o"></i>删除</a>
                                                                    <a href="<?php  echo $this->createWebUrl('aloneCourseList', array('ac' => 'student','id'=>$item['course_id']))?>" class="btn yellow"  > <i class="fa fa-group"></i>授权学生</a>
                                                                    <a href="<?php  echo $this->createWebUrl('aloneCourseList', array('ac' => 'code','id'=>$item['course_id']))?>"   class="btn green"  > <i class="fa fa-reorder"></i>二维码</a>
                                                                  </div>
                                                                </td>
                                                            </tr>
                                                        <?php  } } ?>                                                                                     
