                              ...
                              <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-6">
                                    <div class="color-demo tooltips" >
                                        ...
                                        <?php  } ?>
                                             <div class="color-view bg-<?php  echo $color;?> bg-font-<?php  echo $color;?> bold uppercase"><?php  echo $this->result_result($item,$model,'name','score_list');?> </div>
                                           <?php  if($model =='student') { ?>
                                                <div class=" bg-white c-font-14 sbold">
                                                     <input type="text" class="col-md-12  " style="margin-bottom:10px;" name='score[<?php  echo $item['student_id'];?>]' placeholder="填写成绩"> </div>
                                           <?php  } else { ?>
