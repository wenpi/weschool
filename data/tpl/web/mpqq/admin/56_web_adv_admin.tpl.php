                                    ...
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                                    ...
                                                    <div class='form-group form-md-line-input '>
                                                      ...
                                                      <div class='form-group form-md-line-input '>
                                                        ...
                                                        <div class="col-sm-10">
                                                             <?php  echo upImg('adv_content',$result['adv_content'] ,$this);?>
                                                        </div>	
                                                    </div>		                                                 								
                                               <div class='form-group form-md-line-input '>
                 ...
                 <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-navicon"></i>占位符列表 </div>
                                        <div class="tools">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content table-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-sm label-success"><?php  echo $item['adv_keyword'];?></span></td>
