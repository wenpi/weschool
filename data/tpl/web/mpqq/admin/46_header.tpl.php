<?php defined('IN_IA') or exit('Access Denied');?>        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="<?php  echo $this->createWebUrl("adminindex")?>">
                        <img  src="<?php  echo $_W['attachurl'];?><?php  echo S('base','getKeywordContent',array('logo'))?>" style="    height: 50px; width: 154px;position: relative;top: -20px;" alt="logo" class="logo-default" /> </a>
