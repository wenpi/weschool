                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?php  if($_GPC['_admin_img']) { ?><?php  echo $_W['attachurl'];?><?php  echo $_GPC['_admin_img'];?> <?php  } else { ?><?php echo MODULE_URL;?>/assets/layouts/layout/img/avatar3_small.jpg<?php  } ?>" />
