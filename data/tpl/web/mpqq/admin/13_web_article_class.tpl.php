                                         ...
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr class="success">
                                                ...
                                                <td><a  href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'edit','id'=>$item['class_id'] ))?>" class="btn btn-outline btn-circle btn-sm purple">
                                                 ...
                                                 <a  target="_blank" href="<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapArticle', array('cid' => $item['class_id']))?> " class="btn btn-outline btn-circle btn-sm purple">
                                            ...
                                            <?php  if(is_array($item['list'])) { foreach($item['list'] as $val) { ?>
                                              <tr >
                                                ...
                                                <td><a  href="<?php  echo $this->createWebUrl('article_class', array('ac' => 'edit','id'=>$val['class_id'] ))?>" class="btn btn-outline btn-circle btn-sm purple">
                                                            <i class="fa fa-edit"></i> 编辑 </a>
                                                 <a  target="_blank" href="<?php  echo $_W['siteroot'];?>app/<?php  echo $this->createMobileUrl('wapArticle', array('cid' => $val['class_id']))?> " class="btn btn-outline btn-circle btn-sm purple">
                                                                <i class="fa fa-eye"></i> 访问 </a>   
                                                </td>                          
                                            </tr>                                          
                                            <?php  } } ?>
