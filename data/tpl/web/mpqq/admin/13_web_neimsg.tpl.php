                                ...
                                <div class="portlet-title">
                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                            ...
                                            <div class="form-group  form-md-line-input ">
                                                <label class="col-md-2 control-label"><span class="required" aria-required="true"> * </span>消息（请控制字数）</label>
                                                <div class="col-sm-10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right;">
                                                    <a href="<?php  echo $this->createWebUrl('neimsg', array('id' => $item['msg_id'],'op'=>'edit','aw'=>1))?>" class="btn btn-outline btn-circle btn-sm purple"  >
                                                        <i class="fa fa-pencil"></i>编辑</a>
                                                    <a href="<?php  echo $this->createWebUrl('neimsg', array('id' => $item['msg_id'], 'op'=>'delete','aw'=>1))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" class="btn btn-outline btn-circle dark btn-sm black"  >
