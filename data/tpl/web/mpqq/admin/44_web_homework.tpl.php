<?php defined('IN_IA') or exit('Access Denied');?>   <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../admin/head', TEMPLATE_INCLUDEPATH)) : (include template('../admin/head', TEMPLATE_INCLUDEPATH));?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    【<?php  echo $this->gradeName($item['grade_id']);?>】<?php  echo $item['class_name'];?>
                                                    </span>
                                                </td>
                                         ...
                                         <div class="form-group">
	                                        ...
	                                        <div class="md-radio-inline col-sm-10">
                                              <?php  if(is_array($course_list)) { foreach($course_list as $row) { ?>
                                                <div class="md-radio">
                                                    <input type="radio" id="radion<?php  echo $row['course_id'];?>" class="md-radiobtn course_id " name="course_id"   value='<?php  echo $row['course_id'];?>'  />
    	...
    	<?php  if($ac=='old') { ?>
             <div class="row">
                ...
                <div class="portlet box green-turquoise">
                    <div class="portlet-title">
                      <div class="caption">
                          <i class="fa fa-navicon"></i><?php  echo $class['class_name'];?>*作业记录 </div>
                         <div class="tools">
                               <a href="javascript:;" class="collapse"> </a>
                          </div>
                       </div>
        ...
        <?php  if($ac=='new' || $ac=='edit') { ?>
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"<?php  if($ac=='new') { ?> onsubmit="return onCheck()"<?php  } ?>>
