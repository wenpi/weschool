                 ...
                 <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>用户组列表 </div>
                                    <div class="tools">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($db_list)) { foreach($db_list as $item) { ?>
                                            <tr>
                                               ...
                                               <td>
                                                   <a  href="<?php  echo $this->createWebUrl('group', array('ac' => 'edit','gid'=>$item['group_id'],'db'=>1 ))?>" class="btn btn-outline btn-circle btn-sm purple">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($data_list)) { foreach($data_list as $item) { ?>
                                            <tr>
                                               ...
                                               <td><?php  echo date("Y-m-d H:i:s",$item['add_time']);?></td>                 
                                               <td>
                                                   <a  href="<?php  echo $this->createWebUrl('group', array('ac' => 'edit','gid'=>$item['group_id'],'data'=>1 ))?>" class="btn btn-outline btn-circle btn-sm purple">
                                                            <i class="fa fa-edit"></i> 编辑 </a>
                                               </td>
                                            </tr>
                                        	<?php  } } ?>
