                                                ...
                                                <div class="col-md-10">
                                                    <select id="sys_key" class="form-control" name="sys_key">
                                                        <?php  if(is_array($class_wap->wap_index)) { foreach($class_wap->wap_index as $row) { ?>
                                                            <option value='<?php  echo $row['key'];?>' <?php  if($row['key']==$result['key_word']) { ?> selected <?php  } ?>><?php  echo $row['name'];?></option>
                                                        <?php  } } ?>
                                                    </select>
                                                </div>
                                            </div>  
                                        ...
                                        <tbody>
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr>
                                                ...
                                                <td><a  href="<?php  echo $this->createWebUrl('wap_index', array('ac' => 'edit','id'=>$item['info_id'] ))?>" class="btn blue">
