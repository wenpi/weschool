                                ...
                                <div class="portlet-body form">
                                        <div class="form-body">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text"  class="form-control" value="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=booking&m=lianhu_school&school_id=<?php  echo getSchoolId();?>" readonly />
                                                            </div>
                                                          </div>
                                                        <div class="form-group form-md-line-input">
                                                            <label class=" col-md-2 control-label">微官网[&tem=模板名字调用模板]</label>
                                                            <div class="col-sm-10">
                                                                <input type="text"  class="form-control" value="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=wapHome&m=lianhu_school&school_id=<?php  echo getSchoolId()?>&tem=default" readonly />
                                                            </div>
                                                          </div>
                                                    <div class="form-group form-md-line-input">
