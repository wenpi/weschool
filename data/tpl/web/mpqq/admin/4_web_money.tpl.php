                                        ...
                                        <div class='form-group form-md-line-input'>
                                            ...
                                            <div class="col-sm-10">
                                                <select name='group_id' class="form-control">
                                                    ...
                                                    <?php  if(is_array($money_group_list)) { foreach($money_group_list as $row) { ?>
                                                        <option value='<?php  echo $row['group_id'];?>' <?php  if($result['group_id'] == $row['group_id']) { ?> selected <?php  } ?>><?php  echo $row['group_name'];?></option>
                                                    <?php  } } ?>
                                                </select>
                                            </div>							
                                        </div>  
                                        ...
                                        <tbody>
                                            <?php  if(is_array($list)) { foreach($list as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php  if($row['group_id']) { ?> <?php  echo D("moneyGroup")->groupName($row['group_id']);?><?php  } else { ?>未有<?php  } ?></td>
