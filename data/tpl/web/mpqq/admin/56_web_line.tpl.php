<?php defined('IN_IA') or exit('Access Denied');?>   <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('../admin/head', TEMPLATE_INCLUDEPATH)) : (include template('../admin/head', TEMPLATE_INCLUDEPATH));?>
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content" id="sample_3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="line_<?php  echo $item['line_id'];?>">
                                                ...
                                                <td> <span class="label label-sm label-info"> <?php  echo $this->gradeName($grade_id) ?>&nbsp;<i class="fa fa-toggle-right"></i>&nbsp;<?php  echo $item['class_name'];?></span> </td>
                                                ...
                                                <td id="line_status_<?php  echo $item['line_id'];?>"><span class="label label-sm label-warning"> <?php  if($item['status'] ==1) { ?>正常<?php  } else if($item['status']  == 2) { ?>审核中  <?php  } else { ?>关闭<?php  } ?> </span></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php  if($teacher !='teacher' && $item['status'] == 2 ) { ?>
                                                        <span class='btn purple   queue_num '  data-queue="<?php  echo $item['queue_num'];?>" onclick="passThis('<?php  echo $item['line_id'];?>','line')"><i class='fa fa-check'></i>审核通过</span>
                                                    <?php  } ?>
                                                    <span class='btn  red '      onclick="deleteThis('<?php  echo $item['line_id'];?>','line')"  ><i class='fa fa-minus-square'></i>删除</span>
                                                </td>						
                                            </tr>
                                            <?php  } } ?>
                                        </tbody>
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content table-light" id='sample_3'>
                                        ...
                                        <tbody>
                                         <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                            <tr>
                                                <td> <span class="label label-sm label-info">   <?php  echo $this->gradeName($item['grade_id']) ?>&nbsp;<i class="fa fa-toggle-right"></i>&nbsp;<?php  echo $item['class_name'];?></span> </td>
                                                ...
                                                <td><span class="label label-sm label-warning"> 	<?php  if($item['status'] ==1) { ?>正常<?php  } else { ?><span class='red'>关闭</span><?php  } ?></span></td>
     ...
     <?php  if($ac=='list' || $ac=='old' || $ac=='wait_to_pass') { ?>
