                         ...
                         <?php  if($op=='list') { ?>
                            <div class="portlet box green-turquoise">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-navicon"></i>教师端底部导航列表 </div>
                                    <div class="tools">
                                            ...
                                            <tr >
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('teacher_mobile', array('id' => $item['display_id'], 'op' => 'edit','ac'=>'button' ))?> " class="btn blue">
                                ...
                                <div class="portlet box green-turquoise">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-navicon"></i>教师端首页控制 </div>
                                        <div class="tools">
                                            <a href="javascript:;" class="collapse"> </a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed flip-content">
                                            ...
                                            <?php  if(is_array($index_list)) { foreach($index_list as $item) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src='<?php  echo $this->imgFrom($val['img'])?>' width="50px"></td>
                                                    ...
                                                    <td>
                                                    <div class="btn-group btn-group-solid">
                                                        <a  href="<?php  echo $this->createWebUrl('teacher_mobile', array('id' => $val['display_id'], 'op' => 'edit','ac'=>'index_button' ))?> " class="btn blue">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                    </div>
                                                    </td>         
                                    ...
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                     ...
                                     <?php  if($mu_str == 'xiaoye') { ?>
                                        <div class="form-group form-md-line-input">
                                            <label class="col-md-2 control-label">导航按钮（75*75）</label>
                                            <div class="col-sm-10">
                                                        <?php  $result['img'] = C('mobile')->teacherIndexImg($result['keyword']); ?>
