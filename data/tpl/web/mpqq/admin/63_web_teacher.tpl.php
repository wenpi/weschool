                                ...
                                <div class="portlet-title">
                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <?php  if($grade_id != $row['grade_id'] ) { ?> 
                                                    ...
                                                    <?php  if($i!=1 ) { ?>
                                                        <br>
                                                    <?php  } ?> 
                                                    【<?php  echo $this->gradeName($grade_id);?>】
                                                <?php  } ?>
                                                <input type='checkbox'
                                        ...
                                        <div class='form-group  form-md-line-input'>
                                            <label class="col-md-2 control-label"><span class="required" aria-required="true"> * </span>授课课程<div class='btn btn-circle blue' onclick="allSelect('box_type')">全选</div></label>
                                        ...
                                        <div class='form-group  form-md-line-input'>
                                            <label class="col-md-2 control-label">教师标签<div class='btn btn-circle red-haze' onclick="allSelect('box_type_tags')">全选</div></label>
                                            <div class="col-sm-10" >
                                                <?php  if(is_array($tag_list)) { foreach($tag_list as $row) { ?>
                                                <input type='checkbox' class="box_type_tags"   value='<?php  echo $row['tag_id'];?>' name='teacher_tags[]' <?php  if(@in_array($row['tag_id'],$result['teacher_tags']) ) { ?> checked <?php  } ?>>&nbsp;<?php  echo $row['tag_name'];?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <?php  } } ?>
                                            </div>	
                                        </div>
                                        ...
                                        <div class="form-group  form-md-line-input">
                                            ...
                                            <div class="col-sm-2 col-xs-2">
                                                <input type="number" name="teacher_telphone" id="teacher_telphone" class="form-control" value='<?php  echo $result['teacher_telphone'];?>' />
                                            </div>
                                             <label class="col-md-1 control-label"  >短信通知</label>
                                             <div class="col-md-2">
                                                 <input type="checkbox"  value='1'  <?php  if($result['sms_send']==1) { ?> checked <?php  } ?>  class="make-switch" name="sms_send" data-on-text="发送" data-off-text="不发送">
                                             </div>
                                        </div>
                                        <div class="form-group  form-md-line-input">
                                         ...
                                         <div class="form-group  form-md-line-input">
                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">考勤卡</label>
                                            <div class="col-sm-9 col-xs-8">
                                                <input type="number" name="rfid" id="rfid" class="form-control" value='<?php  echo $result['rfid'];?>' />
                                            </div>
                                        </div>	
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content table-light" id="sample_3">
                                        ...
                                        <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                                <tr> 
                                                    ...
                                                    <td><span class='label label-sm label-success'><?php  echo $item['username'];?></span></td>
                                                    ...
                                                    <td><span class='label label-sm label-info'>
                                                        <?php  if($result=$this->classHead($item['teacher_id'])) { ?>
                                                            <a class='a_use_title' style="color: #fff" href='' title="<?php  echo $this->echoArrOne($result,'class_name');?>">班主任</a>
                                                        <?php  } else { ?>
                                                        否
                                                        <?php  } ?>
                                                        </span>
                                                    ...
                                                    <td style="text-align:center;">
                                                            ...
                                                            <a href="<?php  echo $this->createWebUrl('teacher', array('id' => $item['teacher_id'],'ac'=>'delete' ,'aw'=>1  ))?>" 
                                                                onclick="return confirm('此操作不可恢复，确认删除？');return false;" class="btn  btn yellow " >
                                                                <i class="fa fa-times"></i>删除
                                                            </a>
                                                            <?php  if($item['uid']) { ?>
                                                                <a href="<?php  echo $this->createWebUrl('teacher', array('id' => $item['teacher_id'],'ac'=>'unbundling' ,'aw'=>1  ))?>"  class="btn  red" >
                                                                    <i class="fa fa-trash-o"></i>解绑
                                                                </a>
                                                            <?php  } else { ?>
                                                            <a href="<?php  echo $this->createWebUrl('qrcode', array('id' => $item['teacher_id'], 'op' => 'teacher_bd_qr' ))?>" class="btn  green" target="_blank" title="打印绑定二维码"><i class="fa fa-barcode"></i>绑定</a>
                                                            <?php  } ?>
                                                   </td>
                                                </tr>
                                                <?php  } } ?>                                          
