		...
		<div class="panel-body table-responsive">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><?php  echo $item['in_school_year'];?></td>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>显示年级名【正在使用的，改变将覆盖自动生成的】</label>
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span>入学年份</label>
					<div class="col-sm-9 col-xs-8">
						<input type="text" name="in_school_year" id="in_school_year" class="form-control" value='<?php  echo $result['in_school_year'];?>' />
					</div>
				</div>
				</div>
			</div>
