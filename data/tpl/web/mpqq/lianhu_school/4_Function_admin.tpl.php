...
<ul class="nav nav-tabs">
	...
	<a href="<?php  echo $this->createWebUrl('function_admin')?>">功能列表</a>
	</li>
	<?php  if($ac=='edit') { ?>
	<li <?php  if($ac == 'edit') { ?> class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('function_admin', array( 'ac' => 'edit'))?>">编辑功能</a>
	</li> <?php  } ?>
	<li <?php  if($ac == 'new' ) { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('function_admin', array('ac' => 'new'))?>">升级必点（还原）</a>
	</li>	
</ul>
			...
			<tbody>
				...
				<tr>
					...
					<td>
                        ...
                        <span><a  class='red'  href="<?php  echo $this->createWebUrl('function_admin',array('eeid'=>$item['eid'],'change'=>'lianhu_school_display','ac'=>'edit'))?>">隐藏它</a></span>
                        <?php  } else { ?>
                        <a href="<?php  echo $this->createWebUrl('function_admin',array('eeid'=>$item['eid'],'change'=>'lianhu_school','ac'=>'edit'))?>">显示它</a>
                        <?php  } ?>
					</td>
				</tr>
				<?php  } } ?>
