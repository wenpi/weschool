...
<ul class="nav nav-tabs">
	...
	<li <?php  if($ac == 'system_params_set') { ?> class="active" <?php  } ?>>
		<a href="<?php  echo $this->createWebUrl('systemFix',array('ac'=>'system_params_set') )?>">系统参数设置</a>
	</li>
	<li <?php  if($ac == 'school_type_set') { ?> class="active" <?php  } ?>>
...
<?php  if($op=='list' && $ac=='system_params_set') { ?>
	<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('system_params_set' , TEMPLATE_INCLUDEPATH)) : (include template('system_params_set' , TEMPLATE_INCLUDEPATH));?>
	<?php  exit();?>
<?php  } ?>
<?php  if($op=='list' && $ac=='school_type_set') { ?>
	<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('school_type_set' , TEMPLATE_INCLUDEPATH)) : (include template('school_type_set' , TEMPLATE_INCLUDEPATH));?>
	<?php  exit();?>
<?php  } ?>
<div class="main">
