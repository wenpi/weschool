<?php defined('IN_IA') or exit('Access Denied');?>			<select name='grade_id' class='col-xs-12 col-sm-9 col-lg-3' id='grade_id' style="height:30px;">
			...
			<select name='class_id'  class='col-xs-12 col-sm-9 col-lg-3' style='height:30px' id='class_id'>
