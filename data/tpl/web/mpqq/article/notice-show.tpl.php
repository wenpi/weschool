...
<div class="help">
 ...
 <?php  if(is_array($categroys)) { foreach($categroys as $categroy) { ?>
   <div class="notice_head notice_item" id="notice_avatar" data-acc-type="5">
            <div class="notice_item_inner ui_loading">
                ...
                <a href="<?php  echo url('article/notice-show/list', array('cateid' => $categroy['id']));?>" class="notice_head_a <?php  if($cateid == $categroy['id']) { ?>active<?php  } ?> "><?php  echo $categroy['title'];?></a></div>
 ...
 <div class="table_x" style="visibility: visible;">
        <h2 class="notice_display_head">公告列表</h2>
         <div class="table_size ui_loading_animation" style="height: 550px; transition: height 300ms; overflow: hidden;">
                            ...
                            <tr class="notice_tr">
                                ...
                                <a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>" class="notice_content_a ell"><?php  echo $da['title'];?>...</a>
                                </td>
...
">
    ...
    <?php  if($do == 'detail') { ?>
        ...
        <div class="inner">
                        ...
                        <h3 class="announcement_title"><?php  echo $notice['title'];?></h3>
