...
class uploadHandler{
    ...
    protected function trim_file_name($name, $type, $index, $content_range) {
        ...
        if (strpos($file_name, '.') === false && preg_match($this->accept_file_types, $type, $matches)) {
            $file_name .= '.'.$matches[1];
        }
    ...
    protected function body($str) {
        #结果输出窗口
        #str=('name'=>,'size'=>,'url'=>,'thumbnail_url'=>,'delete_url'=>,'delete_type'=>)
        //echo   $str;
