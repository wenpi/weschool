<?php 
    ...
    if($_GPC['submit']){
            $in['building_num'] = $_GPC['building_num'];
            $in["floor_num"]    = $_GPC['floor_num'];
    ...
    if($ac=='new'){
        if($_GPC['submit']){
            ...
            $this->myMessage("添加成功",$this->createWebUrl("funcroom_building"),"成功");
        }
    }
    ...
    if($ac=='edit'){
        ...
        if($_GPC['submit']){
            ...
            $this->myMessage("编辑成功",$this->createWebUrl("funcroom_building"),"成功");
        }
    }
    ...
    include $this->template('../admin/Building');
	exit();
