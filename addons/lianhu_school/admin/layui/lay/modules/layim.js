...
layui.define(['layer', 'laytpl', 'upload'], function(exports){
  ...
  var layimClose, popmin = function(content){
    ...
    return layer.open({
      ...
      ,shift: 2
      ,offset: 'rb'
      ,content: '<img src="'+ (cache.mine.avatar||(layui.cache.dir+'css/pc/layim/skin/logo.jpg')) +'"><span>'+ (content||cache.base.title||'我的家云') +'</span>'
  ...
  var anim = 'layui-anim-up', events = {
    ...
    //关于
    ,about: function(){
      layer.alert('版本： '+ v + '<br>版权所有：<a href="http://bbs.jiaxt.cn" target="_blank">bbs.jiaxt.cn</a>', {
        title: '关于 家云'
        ,shade: false
      });
    }
  ...
  'modules/layim/layim.css?v=2.09'
  ,'skinlayimcss'
);